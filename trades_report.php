                ...
                <form class="clearfix" method="post" action="trade_report.php">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="datepicker form-control" name="end-date" placeholder="Sluttdato">
                        </div>
                    </div>
                    <div class="form-group">
                        <button type="submit" name="submit" class="btn btn-primary">Generer Rapport</button>
                    </div>
                </form>
            </div>
        </div>
